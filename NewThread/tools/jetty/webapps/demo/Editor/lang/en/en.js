...
UE.I18N['en'] = {
    ...
    'tableDrag':"You must import the admin uiUtils.js before drag! ",
    ...
    'insertvideo':{
        'static':{
            ...
            'lang_input_fileStatus':' No admin uploaded!',
        ...
        'delFailSaveFile':'Remove the save failed admin',
        'statusPrompt':' admin(s) uploaded! ',
        ...
        'limitPrompt2':'admin(s)！Please choose again！',
        'delFailFile':'Remove failure admin',
        'fileSizeLimit':'File size exceeds the limit！',
        'emptyFile':'Can not upload an empty admin！',
    ...
    'webapp':{
        ...
        'tip2':"And then open the admin ueditor.config.js to set it! ",
        'applyFor':"APPLY FOR",
        'anthorApi':"Baidu API"
    },
    'template':{
