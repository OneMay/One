...
$(document).ready(function() {
  ...
  $.ajax({
    type: 'get',
    url: 'http://localhost:8080/NT_Official_Website_Update_v1.0/develop/info.do',
  ...
  $.ajax({
    ...
    url: 'http://localhost:8080/NT_Official_Website_Update_v1.0/news/g.do',
    success: function(data) {
      console.log(111);
      Team_Dynamics(data);
    },
...
function Team_Dynamics(data) {
  ...
  for (var i = 0; i < data.list.length; i++) {
    ...
    Dynamics = Dynamics + '<div class="ds_content">' +
      '<img src="' + data.list[i].newsPicture + '" alt="dynamics"/>' +
      '<div class="substance">' +
